...
export function WellnessCard() {
  ...
  const handleSave = () => {
    updateWellness.mutate({
      ...
      onSuccess: () => toast({ title: t('home.wellnessSaved') }),
    });
  };
    ...
    <Card className="p-4 sm:p-6">
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <div className="flex items-center justify-between mb-4 sm:mb-5">
          <h3 className="text-lg sm:text-[22px] font-semibold text-foreground">{t('home.dailyCheckin')}</h3>
        ...
        <CollapsibleContent>
          <div className="space-y-4 sm:space-y-5">
            <div className="space-y-2">
              ...
              <Input id="steps" type="number" placeholder="0" value={steps} onChange={(e) => setSteps(e.target.value)} />
            ...
            <div className="space-y-2">
              ...
              <Input id="sleep" type="number" placeholder="0" value={sleep} onChange={(e) => setSleep(e.target.value)} />
            ...
            <div className="space-y-2">
              <Label htmlFor="meditation" className="flex items-center gap-2 text-sm font-medium text-foreground">
                ...
                {t('home.meditationGoal')}
              </Label>
              <Input id="meditation" type="number" placeholder="0" value={meditation} onChange={(e) => setMeditation(e.target.value)} />
            ...
            <div className="space-y-2">
              ...
              <Input id="heartRate" type="number" placeholder="70" value={heartRate} onChange={(e) => setHeartRate(e.target.value)} />
            </div>

            <Button onClick={handleSave} className="w-full h-10 sm:h-11 text-[15px]" disabled={updateWellness.isPending}>
              {updateWellness.isPending ? t('common.saving') : t('common.save')}
            </Button>
          </div>
        </CollapsibleContent>
      </Collapsible>
